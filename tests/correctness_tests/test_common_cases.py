...
class TestsCommonCases:
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('str', 'sub', rabin_karp_with_pol_hash_searcher, []),
            ('str', 'str', rabin_karp_with_pol_hash_searcher, [0]),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('Python', 'th', rabin_karp_with_pol_hash_searcher),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('aa', 'a', rabin_karp_with_pol_hash_searcher, [0, 1]),
            ('aba', 'a', rabin_karp_with_pol_hash_searcher, [0, 2]),
            (
                'aba aba',
                'aba',
                rabin_karp_with_pol_hash_searcher,
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ('fsfsf', 'fsf', rabin_karp_with_pol_hash_searcher),

...
class TestsCommonCases:
    ...
    @pytest.mark.parametrize(
            ...
            [
                ...
                ("aba aba", "aba", rabin_karp_with_polynomial_hash_searcher,
                 [0, 4]),
                (
                        "aba aba  aba",
                        "aba",
                ...
                ("aba aba", "aba", rabin_karp_with_square_hash_searcher,
                 [0, 4]),
                ("aba aba  aba", "aba", rabin_karp_with_square_hash_searcher,
                 [0, 4, 9]),
